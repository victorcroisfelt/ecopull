...
This package contains three main scripts that simulate energy consumption based on the integrated communication-computation energy consumption model introduced in the paper. The simulations cover three different scenarios:
...
An `environment.yml` file is provided for easy Conda environment setup.
